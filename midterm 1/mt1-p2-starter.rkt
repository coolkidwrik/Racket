...
;; produces true is numbers are in ascending order
(check-expect (in-order? 3 10 21) true)
(check-expect (in-order? 20 18 19) false)
(check-expect (in-order? 20 19 18) false)
(check-expect (in-order? 20 20 18) false)
(check-expect (in-order? 20 20 20) false)

;(define (in-order? x y z) false) ;stub

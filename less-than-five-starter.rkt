...
;;produces true if string is less than 5 characters

(check-expect (short? "apples") false)
(check-expect (short? "short") false)
(check-expect (short? "long") true)

;(define (short? str) false)

...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname m05-raining-eggs-v1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require 2htdp/image)

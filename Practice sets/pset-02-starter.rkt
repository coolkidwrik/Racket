...
;(define (preference? r) false)

(@template Rating)
(define (preference? r)
  (cond [(or (and (string? r) (string=? r "n/a"))
             (and (number? r) (= r 3))) false]
        [else
         true]))

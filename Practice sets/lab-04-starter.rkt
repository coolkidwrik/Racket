...
(check-expect (cursor-right  (make-editor "" "abc"))   (make-editor "a"  "bc"))
(check-expect (cursor-right  (make-editor "" "a"))   (make-editor "a"  ""))
...
(check-expect (backspace  (make-editor "abc" "de"))   (make-editor "ab"  "de"))
...
(check-expect (insert  (make-editor ""   "ab") "a") (make-editor "a"   "ab"))
(check-expect (insert  (make-editor "ab" "") "a")   (make-editor "aba"  ""))
(check-expect (insert  (make-editor "ab" "c") "a")   (make-editor "aba"  "c"))

...
(check-expect (render-ball  (make-ball (+ LEF 1) TOP  3 -4))
              (place-image  BALL (+ LEF 1)  TOP  MTS))
(check-expect (render-ball  (make-ball LEF (+ TOP 1) -3 4))
              (place-image  BALL LEF  (+ TOP 1)  MTS))
...
(check-expect (bounce-left (make-ball (+ LEF 3) (- BOT 7) -4 2))
              (make-ball (+ LEF 1) (- BOT 7) 4 2))
(check-expect (bounce-left (make-ball (+ LEF 6) (- BOT 5) -7 3))
              (make-ball (+ LEF 1) (- BOT 5) 7 3))
...
(check-expect (bounce-right (make-ball (- RIG 3) (- BOT 5) 4 2))
              (make-ball (- RIG 1) (- BOT 5) -4 2))
(check-expect (bounce-right (make-ball (+ LEF 6) (- BOT 4) -7 3))
              (make-ball (- RIG 1) (- BOT 4) 7 3))
...
(check-expect (glide (make-ball (/ WIDTH 2) (/ HEIGHT 2) 4 2))
              (make-ball (+ (/ WIDTH 2) 4) (+ (/ HEIGHT 2) 2) 4 2))
(check-expect (glide (make-ball (+ LEF 6) (- BOT 7) -1 3))
              (make-ball (+ LEF 5) (- BOT 4) -1 3)) 
#;
(define (glide b) b)

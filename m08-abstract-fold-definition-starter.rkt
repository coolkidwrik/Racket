...
;(@htdf fold-course)
;(@signature _ _ _ _ -> _)
;(@signature _ _ _ Course -> _)
;(@signature (_ _ _ -> _) _ _ Course -> _)
;(@signature (_ _ _ -> _) (_ _ -> _) _ Course -> _)
;(@signature (_ _ _ -> _) (_ Y -> Y) Y Course -> _)
;(@signature (_ _ _ -> _) (X Y -> Y) Y Course -> X)
(@signature (Natural Natural Y -> X) (X Y -> Y) Y Course -> X)
;; fold function for course

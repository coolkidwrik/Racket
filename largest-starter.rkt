...
;;produces largest number of the list
(check-expect (large empty) 0)
(check-expect (large (cons 23 empty)) 23)
(check-expect (large (cons 23 (cons 47 empty))) 47)
(check-expect (large (cons 53 (cons 47 empty))) 53)
